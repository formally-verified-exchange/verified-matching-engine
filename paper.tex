...
narrower in both ambition and cost: we prove preservation of the
specification's full \S13 book-state invariant suite for the Lean
reference implementation of a feature-rich matching engine. The investment is correspondingly smaller (weeks rather than
...
$\sim$5{,}700 lines of case-splitting and omega invocations were the
