---- MODULE MatchingEngine_deep_book ----
(***************************************************************************)
(* Auto-generated from scenarios/deep_book.json. Do not edit by hand.         *)
(*                                                                         *)
...
Init_Seeded ==
    /\ bidQ = [p \in PRICES |->
          CASE p = 1 -> <<MakeOrder(1, "BUY", "LIMIT", "GTC", 1, NULL, 2, NULL, FALSE, NULL, NULL, NULL, 1)>>
            ...
            [] OTHER -> <<>>]
    /\ askQ = [p \in PRICES |->
          CASE p = 4 -> <<MakeOrder(3, "SELL", "LIMIT", "GTC", 4, NULL, 2, NULL, FALSE, NULL, NULL, NULL, 3)>>
